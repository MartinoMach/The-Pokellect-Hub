  ...
  handler: async (request, context) => {
    try {
      ...
      const { resources: users } = await usersContainer.items
        .query({
          query: "SELECT c.id, c.username, c.displayName, c.bio, c.avatarUrl, c.binderIsPrivate, c.createdAt, c.friends, c.friendRequests FROM c WHERE c.username = @username",
