...
jest.mock("../functions/auth", () => ({ authorizeUsername: jest.fn(), issueAuthToken: jest.fn(() => "new-token") }));
...
describe("updateProfile API Function", () => {
  ...
  it("should return 500 on server error", async () => {
    ...
    expect(res.jsonBody.error).toBe("An internal server error occurred while updating the profile.");
  });
});
